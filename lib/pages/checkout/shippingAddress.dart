...
import 'package:flutter_customer/components/checkout/shippingAddressInput.dart';
...
class _ShippingAddressState extends State<ShippingAddress> {
  ...
  listShippingAddress() async{
    ...
    setState(() {
      shippingAddress = data[0];
      addressDocumentId = data[1];
    });
  }
                    ...
                    actions: <Widget>[
                      ...
                      FlatButton(
                        onPressed: () => {
                          ...
                          Firestore.instance.collection("shippingAddress").document(addressDocumentId).updateData({
                            "address": FieldValue.arrayRemove(shippingAddress)
                          })
                            .then((value) => {
                              showInSnackBar("Address successfully deleted", Colors.red),
                              setState((){
