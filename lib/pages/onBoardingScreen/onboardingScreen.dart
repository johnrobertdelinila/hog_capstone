...
import 'package:flutter_customer/pages/onBoardingScreen/slideTitle.dart';
import 'package:flutter_customer/pages/onBoardingScreen/sliderModel.dart';
      ...
      appBar: AppBar(
        ...
        title: GestureDetector(
          ...
          child: Align(
            ...
            child: Container(
              margin: kIsWeb ? EdgeInsets.only(right: 70) : null,
              child: Text(
                'Skip',
                style: TextStyle(
                  fontSize: 20.0,
